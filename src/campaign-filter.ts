...
/** Campaign has fewer than WARM_LEADS_THRESHOLD current leads on the rollup row. */
export function isWarmLeadsCampaign(totalLeads: number): boolean {
  return totalLeads < WARM_LEADS_THRESHOLD;
}
